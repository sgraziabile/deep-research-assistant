...
│                                                                                                                 │
│  <output_instructions>                                                                                          │
│  Carefully scan the brief for any details not explicitly provided by the user. Be strict - when in doubt about  │
│  whether something was user-specified, lean toward FAIL.                                                        │
│  </output_instructions>  
